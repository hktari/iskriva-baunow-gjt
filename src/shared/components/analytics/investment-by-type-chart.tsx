    ...
    >
      <ResponsiveContainer width="100%" height={300}>
        <ComposedChart data={chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          ...
          />
          <Legend />
          <Bar yAxisId="left" dataKey="valueInMillions" fill="hsl(var(--primary))" name="Investment (M EUR)" />
          <Line yAxisId="right" type="monotone" dataKey="count" stroke="hsl(var(--destructive))" name="Project Count" />
        </ComposedChart>
      </ResponsiveContainer>
    </ChartContainer>
  );
